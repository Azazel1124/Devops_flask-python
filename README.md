...
- **k0s** — минималистичный Kubernetes-дистрибутив для локального и облачного развёртывания k8s-кластера.
- **py.py** — альтернативный компилятор/интерпретатор Python для экспериментов и тестирования.
